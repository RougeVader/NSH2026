...
| **24h Long-Range Scan** | **~0.021s** | Verified live with 1,000 objects ($t_{10k} \approx 0.205s$). |
| **Precise TCA Refinement** | 0.064s | Iterative search with 1ms temporal precision. |
